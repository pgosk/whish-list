...
export function ThankYouModal({ isOpen, onClose }: ThankYouModalProps) {
    ...
    return (
        ...
        >
          ...
          border-4 border-fuchsia-300 transition-all duration-500
          ${visible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-75 translate-y-8'}`}
            >
                ...
                <div className="flex justify-center gap-2 text-2xl mb-4 select-none">
                    ...
                    <span style={{ animationDelay: '600ms' }} className="inline-block animate-bounce">🌸</span>
                </div>

                <h2 className="text-2xl font-black text-fuchsia-600 mb-2 leading-snug">
                    Dziękujemy! 💖
                </h2>
                <p className="text-lg font-bold text-rose-500 mb-1">
                    Misia będzie przeszczęśliwa!
                </p>
                ...
                <button
                    onClick={onClose}
                    className="w-full bg-linear-to-r from-fuchsia-500 to-pink-500 hover:from-fuchsia-600 hover:to-pink-600
